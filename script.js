...
{ id: 23, name: "iPhone 15 256GB green", price: 43990, akb: 86, img: "images/iphone15green.jpg" },
...
{ id: 27, name: "iPhone 15 Plus 128GB black", price: 42990, akb: 87, img: "images/iphone15plusblack.jpg" },

{ id: 28, name: "iPhone 16 Pro Max 256GB gold", price: 69990, akb: 93, img: "images/iphone16promaxgold.jpg" },

{ id: 29, name: "Samsung Galaxy Z Fold 6 256GB black", price: 69990, akb: null, img: "images/samsungfold6.jpg" },

{ id: 30, name: "iPhone 12 Pro 256GB gray", price: 26490, akb: 100, img: "images/iphone12progray.jpg" },

{ id: 31, name: "iPhone 16 Pro 256GB gray", price: 64990, akb: 91, img: "images/iphone16progray.jpg" },

{ id: 32, name: "iPhone 14 128GB white", price: 27990, akb: 80, img: "images/iphone14white.jpg" },

{ id: 33, name: "iPhone 13 128GB white (alt)", price: 26490, akb: 85, img: "images/iphone13white.jpg" },

{ id: 34, name: "iPhone 13 mini 256GB blue", price: 20990, akb: 84, img: "images/iphone13miniblue.jpg" },

{ id: 35, name: "iPhone 14 Pro Max 128GB (no color)", price: 43990, akb: 85, img: "images/iphone14promaxgray.jpg" },

{ id: 36, name: "Apple Watch 11 46mm", price: 33990, akb: 100, img: "images/applewatch11.jpg" },

{ id: 37, name: "iPhone 17 Pro Max 256GB orange (higher)", price: 110990, akb: 100, img: "images/iphone17promaxorange.jpg" },

{ id: 38, name: "Apple Watch 10 46mm", price: 21990, akb: 100, img: "images/applewatch10.jpg" },

{ id: 39, name: "iPhone 14 Pro 512GB gray", price: 49990, akb: 87, img: "images/iphone14progray.jpg" },

{ id: 40, name: "Apple Watch 11 46mm (alt)", price: 29990, akb: 100, img: "images/applewatch11.jpg" },

{ id: 41, name: "iPhone 12 Pro 256GB gray (alt)", price: 27490, akb: 85, img: "images/iphone12progray.jpg" },

{ id: 42, name: "Apple Watch Ultra 2 orange", price: 38990, akb: 98, img: "images/applewatchultra2orange.jpg" },

{ id: 43, name: "iPhone 14 128GB lavender", price: 28990, akb: 82, img: "images/iphone14lavender.jpg" },

{ id: 44, name: "iPhone 14 256GB blue", price: 32490, akb: 80, img: "images/iphone14blue.jpg" },

{ id: 45, name: "iPhone 15 128GB pink", price: 40990, akb: 87, img: "images/iphone15pink.jpg" },

{ id: 46, name: "iPhone 13 256GB black", price: 34990, akb: 89, img: "images/iphone13black.jpg" },

{ id: 47, name: "iPhone 13 Pro Max 128GB blue (alt)", price: 39990, akb: 90, img: "images/iphone13promaxblue.jpg" },

{ id: 48, name: "iPhone 13 256GB red", price: 32990, akb: 86, img: "images/iphone13red.jpg" },

{ id: 49, name: "iPhone 15 Pro Max 256GB gray", price: 68490, akb: 87, img: "images/iphone15promaxgray.jpg" },

{ id: 50, name: "iPhone 14 Pro 128GB deep purple", price: 49990, akb: 100, img: "images/iphone14prodeeppurple.jpg" },

{ id: 51, name: "Google Pixel 8 Pro 128GB blue", price: 36490, akb: null, img: "images/googlepixel8problue.jpg" },

{ id: 52, name: "Google Pixel 8 Pro 128GB black", price: 36990, akb: null, img: "images/googlepixel8problack.jpg" },

{ id: 53, name: "iPhone 13 Pro Max 128GB white", price: 42490, akb: 91, img: "images/iphone13promaxwhite.jpg" },
...
<div class="akb">${p.akb ? `АКБ: ${p.akb}%` : "АКБ неизвестен"}</div>
...
itemsDiv.innerText = "Корзина пуста";

totalDiv.innerText = "";

} else {

itemsDiv.innerHTML = cart.map(item => `<div>${item.name} — ${item.price.toLocaleString()} ₽</div>`).join("");

totalDiv.innerHTML = `<strong>Итого: ${getCartTotal().toLocaleString()} ₽</strong>`;
...
await fetch("https://formsubmit.co/ajax/ilacernuk25@gmail.com", { method: "POST", body: formData });
